...
public class AddStudent implements ActionListener{
	 JFrame f;
	    ...
	    public AddStudent(){
	        ...
	        id15=new JLabel();
	        id15.setBounds(0,0,900,900);
	        id15.setLayout(null);
	        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("university/management/system/icons/classs.jpg"));
		...
		lab.setFont(new Font("serif",Font.BOLD,20));
	        ...
	        String course[] = {"B.Tech","M.Tech","Bsc","Msc","BCA","MCA"};
		...
		lab2.setFont(new Font("serif",Font.BOLD,20));
	        ...
	        String branch[] = {"Computer Science","Information Technology","Electronics & Telecommunication","Artificial Intellegence","Data Science","Electrical","Mechanical","Civil"};
