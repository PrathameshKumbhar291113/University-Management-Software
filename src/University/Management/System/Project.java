...
public class Project extends JFrame implements ActionListener{
    Project(){
        super("Princeton University");
        
        setBounds(200,100,1200, 700);//setBounds(distance from x axis , distance from y axis , length of the img , breadth of the img);
          
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("University/Management/System/icons/uni.jpeg"));
